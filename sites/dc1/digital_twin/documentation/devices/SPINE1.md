...
| --------- | --------------- | ------------ | --------- |
| DC1-SPINES | Vlan4094 | 10.253.1.1 | Port-Channel971 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_LEAF1A_Ethernet49 | *trunk | *110,120,130,140-141 | *- | *- | 1 |
| Ethernet2 | L2_LEAF1B_Ethernet49 | *trunk | *110,120,130,140-141 | *- | *- | 1 |
| Ethernet3 | L2_LEAF2A_Ethernet49 | *trunk | *110,120,130,140-141 | *- | *- | 3 |
| Ethernet4 | L2_LEAF2B_Ethernet49 | *trunk | *110,120,130,140-141 | *- | *- | 3 |
| Ethernet97/1 | MLAG_SPINE2_Ethernet97/1 | *trunk | *- | *- | *MLAG | 971 |
| Ethernet98/1 | MLAG_SPINE2_Ethernet98/1 | *trunk | *- | *- | *MLAG | 971 |
...
!
interface Ethernet1
   description L2_LEAF1A_Ethernet49
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_LEAF1B_Ethernet49
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description L2_LEAF2A_Ethernet49
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description L2_LEAF2B_Ethernet49
   no shutdown
   channel-group 3 mode active
!
interface Ethernet97/1
   description MLAG_SPINE2_Ethernet97/1
   no shutdown
   channel-group 971 mode active
!
interface Ethernet98/1
   description MLAG_SPINE2_Ethernet98/1
   no shutdown
   channel-group 971 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_DC1-LEAF1_Port-Channel49 | trunk | 110,120,130,140-141 | - | - | - | - | 1 | - |
| Port-Channel3 | L2_DC1-LEAF2_Port-Channel49 | trunk | 110,120,130,140-141 | - | - | - | - | 3 | - |
| Port-Channel971 | MLAG_SPINE2_Port-Channel971 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel971
   description MLAG_SPINE2_Port-Channel971
   no shutdown
   switchport mode trunk
...
| Vlan130 | DC1_VLAN130 | default | - | False |
| Vlan140 | DC1_VLAN140 | default | - | False |
| Vlan141 | DC1_VLAN141 | default | - | False |
